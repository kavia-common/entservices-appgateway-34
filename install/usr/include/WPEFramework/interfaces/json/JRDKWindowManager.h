...
namespace Exchange {
    ...
    namespace JRDKWindowManager {
        ...
        static void Register(JSONRPC& _module_, IRDKWindowManager* _impl_)
        {
            ...
            // Method: 'setZOrder' - Sets the zOrder of the given client or appInstanceId
            _module_.Register<JsonData::RDKWindowManager::SetZOrderParamsData, void>(_T("setZOrder"), 
                [_impl_](const JsonData::RDKWindowManager::SetZOrderParamsData& params) -> uint32_t {
                    uint32_t _errorCode = Core::ERROR_NONE;

                    const string _appInstanceId{params.AppInstanceId};
                    const int32_t _zOrder{params.ZOrder};

                    _errorCode = _impl_->SetZOrder(_appInstanceId, _zOrder);

                    return (_errorCode);
                });

            // Method: 'getZOrder' - Gets the zOrder of the given client or appInstanceId
            _module_.Register<JsonData::RDKWindowManager::GetZOrderParamsInfo, Core::JSON::DecSInt32>(_T("getZOrder"), 
                [_impl_](const JsonData::RDKWindowManager::GetZOrderParamsInfo& params, Core::JSON::DecSInt32& zOrder) -> uint32_t {
                    uint32_t _errorCode = Core::ERROR_NONE;

                    const string _appInstanceId{params.AppInstanceId};
                    int32_t _zOrder{};

                    _errorCode = _impl_->GetZOrder(_appInstanceId, _zOrder);
            ...
            // Method: 'startVncServer' - Starts the VNC server
            _module_.Register<void, void>(_T("startVncServer"), 
                [_impl_]() -> uint32_t {
                    uint32_t _errorCode = Core::ERROR_NONE;

                    _errorCode = _impl_->StartVncServer();

                    return (_errorCode);
                });

            // Method: 'stopVncServer' - Stops the VNC server
            _module_.Register<void, void>(_T("stopVncServer"), 
                [_impl_]() -> uint32_t {
                    uint32_t _errorCode = Core::ERROR_NONE;

                    _errorCode = _impl_->StopVncServer();
        ...
        static void Unregister(JSONRPC& _module_)
        {
            ...
            _module_.Unregister(_T("setZOrder"));
            _module_.Unregister(_T("getZOrder"));
            _module_.Unregister(_T("startVncServer"));
            _module_.Unregister(_T("stopVncServer"));
        }
        ...
        namespace Event {
            ...
            static void OnConnected(const JSONRPC& _module_, const JsonData::RDKWindowManager::GetZOrderParamsInfo& params)
            {
            ...
            {
                JsonData::RDKWindowManager::GetZOrderParamsInfo _params_;
            ...
            static void OnVisible(const JSONRPC& _module_, const JsonData::RDKWindowManager::GetZOrderParamsInfo& params)
            {
            ...
            static void OnHidden(const JSONRPC& _module_, const JsonData::RDKWindowManager::GetZOrderParamsInfo& params)
            {
            ...
            static void OnFocus(const JSONRPC& _module_, const JsonData::RDKWindowManager::GetZOrderParamsInfo& params)
            {
            ...
            static void OnBlur(const JSONRPC& _module_, const JsonData::RDKWindowManager::GetZOrderParamsInfo& params)
            {
