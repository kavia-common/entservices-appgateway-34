...
namespace JsonData {
    ...
    namespace RDKWindowManager {
        ...
        class GetZOrderParamsInfo : public Core::JSON::Container {
        public:
            GetZOrderParamsInfo()
                : Core::JSON::Container()
            {
            ...
            GetZOrderParamsInfo(const GetZOrderParamsInfo&) = delete;
            GetZOrderParamsInfo& operator=(const GetZOrderParamsInfo&) = delete;

        public:
            Core::JSON::String AppInstanceId; // client name or application instance ID
        }; // class GetZOrderParamsInfo
        ...
        class SetZOrderParamsData : public Core::JSON::Container {
        public:
            SetZOrderParamsData()
                : Core::JSON::Container()
            {
            ...
            SetZOrderParamsData(const SetZOrderParamsData&) = delete;
            SetZOrderParamsData& operator=(const SetZOrderParamsData&) = delete;

        public:
            Core::JSON::String AppInstanceId; // client name or application instance ID
            Core::JSON::DecSInt32 ZOrder; // integer value indicating the zOrder
        }; // class SetZOrderParamsData
