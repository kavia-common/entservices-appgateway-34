...
namespace Exchange {
    ...
    namespace JPackageManager {
        ...
        static void Register(JSONRPC& _module_, IPackageManager* _impl_)
        {
            ...
            // Method: 'install' - Downloads and installs an application bundle
            ...
            // Method: 'uninstall' - Uninstalls an application
            ...
            // Method: 'download' - Downloads a resource file for an application
            ...
            // Method: 'reset' - Deletes all persistent local data of the application
            ...
            // Method: 'getStorageDetails' - Retrieves details about app and persistent storage usage
            ...
            // Method: 'setAuxMetadata' - Sets a key-value pair of metadata for the application
            ...
            // Method: 'clearAuxMetadata' - Clears the specified metadata key
            ...
            // Method: 'getMetadata' - Retrieves metadata and auxiliary resource list for an application
            ...
            // Method: 'cancel' - Cancels a previously issued asynchronous request
            ...
            // Method: 'getProgress' - Provides the current progress of an ongoing operation
            ...
            // Method: 'getList' - Retrieves list of installed apps matching given filters
            ...
            // Method: 'lock' - Locks an application to prevent uninstallation
            ...
            // Method: 'unlock' - Unlocks a previously locked application
            ...
            // Method: 'getLockInfo' - Provides lock reason and owner for an app
        ...
        namespace Event {
            ...
            // Event: 'operationStatus' - Notifies completion of an asynchronous operation
