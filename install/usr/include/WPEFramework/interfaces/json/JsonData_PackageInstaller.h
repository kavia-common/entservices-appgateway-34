    ...
    namespace PackageInstaller {
        ...
        public:
                ...
                : Core::JSON::Container()
            {
                ...
                RalfPkgPath = _other.ralfPkgPath;
            ...
            operator Exchange::RuntimeConfig() const
            {
                ...
                _value.ralfPkgPath = RalfPkgPath;
        ...
        private:
            void _Init()
            {
                ...
                Add(_T("ralfPkgPath"), &RalfPkgPath);
        ...
        public:
            ...
            Core::JSON::String RalfPkgPath; // Config
