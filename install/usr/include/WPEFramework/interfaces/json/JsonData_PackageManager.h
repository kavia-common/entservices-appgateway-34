...
namespace JsonData {
    ...
    namespace PackageManager {
        ...
        public:
            Core::JSON::String Handle; // Cancels a previously issued asynchronous request.
        ...
        public:
            Core::JSON::String Type; // Retrieves details about app and persistent storage usage.
            Core::JSON::String Id; // Retrieves details about app and persistent storage usage.
            Core::JSON::String Version; // Retrieves details about app and persistent storage usage.
        ...
        public:
            Core::JSON::String Type; // Clears the specified metadata key.
            Core::JSON::String Id; // Clears the specified metadata key.
            Core::JSON::String Version; // Clears the specified metadata key.
            Core::JSON::String Key; // Clears the specified metadata key.
        ...
        public:
            Core::JSON::String Type; // Downloads a resource file for an application.
            Core::JSON::String Id; // Downloads a resource file for an application.
            Core::JSON::String Version; // Downloads a resource file for an application.
            Core::JSON::String ResKey; // Downloads a resource file for an application.
            Core::JSON::String Url; // Downloads a resource file for an application.
        ...
        public:
            Core::JSON::String Type; // Retrieves list of installed apps matching given filters.
            Core::JSON::String Id; // Retrieves list of installed apps matching given filters.
            Core::JSON::String Version; // Retrieves list of installed apps matching given filters.
            Core::JSON::String AppName; // Retrieves list of installed apps matching given filters.
            Core::JSON::String Category; // Retrieves list of installed apps matching given filters.
        ...
        public:
            Core::JSON::String Reason; // Provides lock reason and owner for an app.
            Core::JSON::String Owner; // Provides lock reason and owner for an app.
        }; // class LockInfoData
        ...
        public:
            GetMetadataResultData::MetadataPayloadData Metadata; // Retrieves metadata and auxiliary resource list for an application.
            Core::JSON::ArrayType<KeyValueInfo> Resources; // Retrieves metadata and auxiliary resource list for an application.
            Core::JSON::ArrayType<KeyValueInfo> AuxMetadata; // Retrieves metadata and auxiliary resource list for an application.
        ...
        public:
            StorageInfoData::StorageDetailsData Apps; // Retrieves details about app and persistent storage usage.
            StorageDetailsData Persistent; // Retrieves details about app and persistent storage usage.
        ...
        public:
            Core::JSON::String Type; // Downloads and installs an application bundle.
            Core::JSON::String Id; // Downloads and installs an application bundle.
            Core::JSON::String Version; // Downloads and installs an application bundle.
            Core::JSON::String Url; // Downloads and installs an application bundle.
            Core::JSON::String AppName; // Downloads and installs an application bundle.
            Core::JSON::String Category; // Downloads and installs an application bundle.
        ...
        public:
            Core::JSON::String Type; // Locks an application to prevent uninstallation.
            Core::JSON::String Id; // Locks an application to prevent uninstallation.
            Core::JSON::String Version; // Locks an application to prevent uninstallation.
            Core::JSON::String Reason; // Locks an application to prevent uninstallation.
            Core::JSON::String Owner; // Locks an application to prevent uninstallation.
        ...
        public:
            Core::JSON::String Handle; // Notifies completion of an asynchronous operation.
            Core::JSON::String Operation; // Notifies completion of an asynchronous operation.
            Core::JSON::String Type; // Notifies completion of an asynchronous operation.
            Core::JSON::String Id; // Notifies completion of an asynchronous operation.
            Core::JSON::String Version; // Notifies completion of an asynchronous operation.
            Core::JSON::String Status; // Notifies completion of an asynchronous operation.
            Core::JSON::String Details; // Notifies completion of an asynchronous operation.
        ...
        public:
            Core::JSON::String Type; // Deletes all persistent local data of the application.
            Core::JSON::String Id; // Deletes all persistent local data of the application.
            Core::JSON::String Version; // Deletes all persistent local data of the application.
            Core::JSON::String ResetType; // Deletes all persistent local data of the application.
        ...
        public:
            Core::JSON::String Type; // Sets a key-value pair of metadata for the application.
            Core::JSON::String Id; // Sets a key-value pair of metadata for the application.
            Core::JSON::String Version; // Sets a key-value pair of metadata for the application.
            Core::JSON::String Key; // Sets a key-value pair of metadata for the application.
            Core::JSON::String Value; // Sets a key-value pair of metadata for the application.
        ...
        public:
            Core::JSON::String Type; // Uninstalls an application.
            Core::JSON::String Id; // Uninstalls an application.
            Core::JSON::String Version; // Uninstalls an application.
            Core::JSON::String UninstallType; // Uninstalls an application.
